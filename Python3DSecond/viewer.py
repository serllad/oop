...
class Viewer(object):
    ...
    def init_opengl(self):
        """ 初始化opengl的配置 """
        #模型视图矩阵
        self.inverseModelView = numpy.identity(4)#identity返回单位矩阵
        #模型视图矩阵的逆矩阵
    ...
    def render(self):
        ...
        self.modelView = numpy.transpose(currentModelView)#transpose转置矩阵
        self.inverseModelView = inv(numpy.transpose(currentModelView))#inv求逆矩阵
